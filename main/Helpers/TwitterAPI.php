...
class TwitterAPI
{
  ...
  private $requestTokenURL = 'http://twitter.com/oauth/request_token';
  private $accessTokenURL = 'http://twitter.com/oauth/access_token';
  private $loginURL = 'http://twitter.com/oauth/authorize';

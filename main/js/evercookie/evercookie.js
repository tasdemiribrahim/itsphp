...
this.evercookie_etag = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.src = '/main/js/evercookie/evercookie_etag.php?name=' + name;
	}
	else
	{
		...
		$.ajax({
			url: '/main/js/evercookie/evercookie_etag.php?name=' + name,
...
this.evercookie_lso = function(name, value)
{
	...
	swfobject.embedSWF("/main/js/evercookie/evercookie.swf", "swfcontainer", "1", "1", "9.0.0", false, flashvars, params, attributes);
}
...
this.evercookie_png = function(name, value)
{
	if (document.createElement('canvas').getContext)
	{
		if (typeof(value) != "undefined")
		{
			...
			img.style.visibility = 'hidden';
			img.style.position = 'absolute';
			img.src = '/main/js/evercookie/evercookie_png.php?name=' + name;
		}
		else
		{

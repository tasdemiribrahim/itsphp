...
class FeedController extends Zend_Controller_Action
{
	...
	public function muzikAction()
	{
		...
		$q = Doctrine_Query::create()->from('main_Models_MuzikRssItems r')->orderby("r.id DESC");
		$result = $q->fetchArray();
		$q->free();
		echo "<?xml version='1.0' encoding='UTF-8' ?>
				<rss version='2.0'>
					<channel>
						...
						<link>http://tasdemir.0fees.net/dinle/metal</link>
	...
	public function aileagaciAction()
	{		
		//if($_SERVER['HTTP_USER_AGENT']!="FeedBurner")
		//	$this->_redirect("http://feeds.feedburner.com/aile-itsphp");
		$q = Doctrine_Query::create()->from('main_Models_AileAgaciRssItems r')->orderby("r.id DESC");
		$result = $q->fetchArray();
		$q->free();
		echo "<?xml version='1.0' encoding='UTF-8' ?>
				<rss version='2.0'>
					<channel>
						...
						<link>http://tasdemir.0fees.net/aile</link>
						<pubDate>2010-08-29 00:00:00</pubDate>

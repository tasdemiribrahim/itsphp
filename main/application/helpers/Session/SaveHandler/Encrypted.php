<?php
class main_application_helpers_Session_SaveHandler_Encrypted extends Zend_Session_Namespace 
{
	...
	{
		parent::__set($key,bin2hex(mcrypt_encrypt(self::CIPHER,$this->secretKey,$value,self::MODE,$this->_iv)));
	}

	public function & __get($key)
	{
		if(parent::__get($key))
			return rtrim(mcrypt_decrypt(self::CIPHER,$this->secretKey,pack('H*',parent::__get($key)),self::MODE,$this->_iv), "\0");
		else return null;
	}
}
